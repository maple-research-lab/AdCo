...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.dataset == "ImageNet":
        ...
        #     ])
        # if args.add_crop:
        #     from Data_Processing.MultiCrop_Transform import Multi_Fixtransform,MultiCrop_transform,TenCrop_transform
        #     #transform_train=Multi_Fixtransform(args.size_crops,
        #     #args.min_scale_crops,
        #     #args.max_scale_crops,normalize)
        #     transform_train=MultiCrop_transform(args.add_crop,args.aug_type,normalize)
        #     #transform_test = TenCrop_transform(normalize)
        #     transform_test = transforms.Compose([
        #         transforms.Resize(256),
        #         transforms.CenterCrop(224),
        #         transforms.ToTensor(),
        ...
        #    # if args.add_crop:
        #    #     from Data_Processing.MultiCrop_Transform import Last_transform
        #    #     transform_train=Last_transform(args.add_crop,transform_train)
        #     # transform_test = TenCrop_transform(normalize)
        #     transform_test = transforms.Compose([
        #         transforms.Resize(256),
        #         transforms.CenterCrop(224),
        ...
        #         normalize,
        #     ])
        #     from Data_Processing.Weak_Strong_Transform import Weak_Strong_transform
        #     transform_train =Weak_Strong_transform(224,normalize)
        # if args.final:
        # from Data_Processing.MultiCrop_Transform import Final_transform
        # transform_train=Multi_Fixtransform(args.size_crops,
        # args.min_scale_crops,
        # args.max_scale_crops,normalize)
        # transform_train = Final_transform(args.add_crop,normalize)
        # from Data_Processing.Finetune_Augment import RandAugment
